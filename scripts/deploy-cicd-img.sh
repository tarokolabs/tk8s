...
sudo podman build --format=docker --build-arg="VER=3.20.0" --no-cache --force-rm --squash-all -t dkreg.kube-system:5000/alp.jkagent:${VER} ${WULIN_DIR}/images/jkagent &>/dev/null
